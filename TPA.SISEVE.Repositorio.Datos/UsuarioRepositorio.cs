...
namespace TPA.SISEVE.Repositorio.Datos
{
    public class UsuarioRepositorio : Repositorio<UsuarioRepositorio>,  IUsuarioRepositorio
    {
        ...
        {
            DbCommand Comando = BaseDatos.GetSqlStringCommand("select idusuario, login, claveacceso, indexpiracionclave, fechaexpiracionclave, dni, apellidopaterno, apellidomaterno, nombre, situacionregistro, fechacreacion, usuariocreacion from usuario");
        ...
        {
            DbCommand Comando = BaseDatos.GetSqlStringCommand("select idusuario, login, claveacceso, indexpiracionclave, fechaexpiracionclave, dni, apellidopaterno, apellidomaterno, nombre, situacionregistro, fechacreacion, usuariocreacion from usuario where idusuario = @idusuario");
            BaseDatos.AddInParameter(Comando, "@idusuario", DbType.Int32, id);
